...
const Card = ({ name, addLikes, removeLikes, removeImage }) => {
    ...
    return (
        <div className='card'>
            ...
            <br />
            <button className='likes' alt="likes" onClick={() => handleLikes('add')}>Add Likes</button>
            <button className='dislikes' alt="dislikes" onClick={() => handleLikes('remove')}>Remove Likes</button>
